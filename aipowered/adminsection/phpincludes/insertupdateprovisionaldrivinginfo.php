<?php
if(isset($_POST['saveprovisional']))
{
    $id = $_POST['id'] ?? '';
    ...
    if($id) {
        $sql = "UPDATE provisionaldrivinginfo SET
        ...
        $sql = "INSERT INTO provisionaldrivinginfo
    ...
    if(mysqli_query($conn, $sql)) {
        ...
        swal({
          title: 'Success!',
          text: 'Provisional Driving service saved successfully.',
          icon: 'success',
          button: 'OK'
        }).then(() => {
